...
*Cross-links: FALSIFICATION_REGISTER.md (what would falsify) · EMPIRICAL_INVENTORY.md (what has been measured)*
...
**Code path:** `01_CASCADE/essentials.md` — `KnowledgePyramid` class; `cascade_engine.py` — `partition_knowledge()`
...
**Code path:** `01_CASCADE/CASCADE_THEOREMS.md` — formal proof; `cascade_engine.py` — `update_with_invariant_check()`
...
**Code path:** `01_CASCADE/implementations/cascade_synthetic_experiment.py`
...
**Code path:** `03_LAMAGUE/LAMAGUE_CROSS_CULTURAL_PAPER.md` — paper draft; `lamague_reference.py`
...
**Code path:** `04_TRIAD/implementations/`; Lyapunov verification suite
...
**Code path:** `05_MICROORCIM/implementations/microorcim_monitor.py`
...
**Code path:** `05_MICROORCIM/MICROORCIM_THEOREMS.md` — proof; `microorcim_monitor.py` — `sovereignty_score()`
...
**Code path:** `07_ANAMNESIS/TC_CATALOG.md`; `anamnesis_tc.py` — `compute_tc(structure, traditions)`
...
**Code path:** `FORMAL_SPINE.md` — Lemma XF1 proof; `system_integration.py`
...
*Cross-links: FALSIFICATION_REGISTER.md · EMPIRICAL_INVENTORY.md · PROVENANCE_INDEX.md*
