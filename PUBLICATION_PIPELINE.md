...
**Depends on:** EMPIRICAL_INVENTORY.md (Act VI), PRIOR_ART.md (Act V),
               CODEX_DISTILLATION.md (Act VIII)
...
The calibration is Priority 1 in the empirical program (EMPIRICAL_INVENTORY.md).
...
2. Formal proof that the frameworks are internally consistent (CODEX_DISTILLATION.md
...
3. **Supplementary materials:** Papers 2, 3, and 5 will require full mathematical
   proofs in supplementary material. These should be drawn from `FORMAL_SPINE.md`
