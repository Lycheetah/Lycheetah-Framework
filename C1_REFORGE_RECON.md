...
|---|---|---|---|---|---|
| README L80–83 / FIVE_MINUTE_BRIEF L36–42 / `CLAIMS.json` | 37 | 14 | 6 | 3 | **60** |
| `CLAIM_STATUS_LEDGER.md` (memory says 17/26/16) | 17 | 26 | 16 | — | **59** |

**C1 audit (CC-01) flagged this as MEDIUM and proposed:** add a note to README distinguishing "from CLAIMS.json (60 records, all status-tagged)" vs "CLAIM_STATUS_LEDGER (59 load-bearing claims at framework granularity)."
...
**Reforge directive:** README badge update to "D-1.2 shipped". DEFENSE_VERSION.md verify.
...
**Authority for restoration:** I (Sol/Opus) restore in Wave 2; Mac reviews `REFORGE_REGISTER.md` at end. Faster than per-line approval. Mac confirms in §VIII below.
...
|---|---|---|---|---|---|
| `CODEX_DISTILLATION.md` | 7 | 5 | 12 | 30 | **P0** — most-read long doc |
| `01_CASCADE/CASCADE_COMPLETE.md` | 14 | — | — | 4 | P1 — worst hype offender |
| `papers/LIMITATIONS_AND_FUTURE.md` | 8 | — | — | — | P1 — limitations doc that uses marketing voice undermines its own purpose |
| `03_LAMAGUE/TRI_LINGUISTIC_DEEP_DIVE.md` | 5 | — | 4 | 17 | P1 — high consciousness density needs scoping audit |
| `THE_SOL_PROTOCOL.md` | — | 3 | 2 | 4 | P2 — voice intentional, verify operational referents |
| `02_AURA/THE_FOUR_PRINCIPLES.md` | 3 | — | — | — | P2 |
