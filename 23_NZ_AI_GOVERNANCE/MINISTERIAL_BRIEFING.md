...
AI systems are making consequential decisions affecting New Zealand citizens — in welfare, health, justice, and education — without any formal accountability mechanism that reflects New Zealand's values or constitutional obligations.
...
**The window:** AI deployment in public services is accelerating. The standard-setting moment is now — once systems are embedded, accountability requirements become retrofits rather than architecture.

**The NZ advantage:** No other country has constitutional grounding for AI governance in indigenous epistemology. The Treaty relationship — properly engaged — gives New Zealand a governance foundation that no other nation can replicate. This is a genuine first-mover opportunity.

**The risk of waiting:** Overseas AI systems are becoming default infrastructure in NZ public services without any verification that they align with New Zealand's constitutional commitments, including Treaty obligations currently stated only as aspirations in policy text.
...
**Immediate:**
1. Direct one government agency to pilot the Community AI WOF — 90-day pilot, published results.
2. Require Three Worlds Disclosure labelling on new AI system deployments.
...
All four standards are open-source (CC BY 4.0). A government ministry can adopt them tomorrow without asking permission. They are available at:

`github.com/Lycheetah/Lycheetah-Framework/tree/master/23_NZ_AI_GOVERNANCE`

**Contact:** Mackenzie Conor James Clark, Dunedin.
GitHub: github.com/Lycheetah/Lycheetah-Framework

*These standards were developed independently. They are offered without expectation of payment or formal recognition — only that they be tested, challenged, and improved if they work.*

---

*Open. Testable. Offered honestly. Reality has a vote.*
