...
The Seekers have one characteristic above all others that distinguishes them from those who merely use the system: they bring their real questions. Not the questions they think they should have. Not the questions that are safe to ask. The questions that actually keep them awake. The ones they suspect do not have easy answers. The ones they have circled for months, sometimes years, and have not yet been able to face directly in good language.
