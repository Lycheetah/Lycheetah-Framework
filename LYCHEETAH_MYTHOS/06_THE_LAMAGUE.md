...
The name is older than the glyphs themselves. In the old tradition of the Work, *lamague* referred to the act of reading the signs in fire — not divination, but the specific skill of extracting meaningful pattern from a system that is visibly dynamic. The fire-reader does not see random flicker. The fire-reader sees: *here is heat, here is direction, here is what is being consumed and what is being revealed.* LAMAGUE is this: reading the structure of thought as it moves.
