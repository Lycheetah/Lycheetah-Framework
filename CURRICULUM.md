...
**Depends on:** CODEX_DISTILLATION.md (Act VIII), PRACTITIONERS_MANUAL.md (Act XVIII),
               ARCHITECTS_GUIDE.md (Act XIX)
...
in FORMAL_SPINE.md without assistance? If not, spend time in recommended texts first.
...
ability to read the reference implementations in REPRODUCIBILITY_REPORT.md.
...
**Reading:** CODEX_DISTILLATION.md, Part III — AURA
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part III — CASCADE; VISUAL_ATLAS.md Figures F-05, F-06
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part III — TRIAD; VISUAL_ATLAS.md Figures F-08, F-09
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part III — LAMAGUE
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part III — MICROORCIM; VISUAL_ATLAS.md Figure F-10
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part III — EARNED LIGHT
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part III — ANAMNESIS
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part III — CHRYSOPOEIA; VISUAL_ATLAS.md Figures F-13, F-14
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part III — HARMONIA; VISUAL_ATLAS.md Figures F-15, F-16
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md, Part IV; COMPOSITION_MAP.md
**Key questions:**
...
**Reading:** CODEX_DISTILLATION.md Part V; ADVERSARIAL_AUDIT_REPORT.md; OPEN_PROBLEMS.md
**Key questions:**
...
FORMAL_SPINE.md, the implementation in REPRODUCIBILITY_REPORT.md, and the open
problems in OPEN_PROBLEMS.md.
...
Contributions are submitted through the process defined in LIVING_CODEX_PROTOCOL.md (Act XXII).
