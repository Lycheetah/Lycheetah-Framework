...
**Parallels:** `29_GOVERNANCE/CODEX_ELEVATION_PLAN.md` (which produced canonical body C-1.0).
...
**Outputs:** rewritten `README.md` + new `28_DEFENSE/READING_PATHS.md`
...
3. Add reading-time paths section linking to `28_DEFENSE/READING_PATHS.md`.
4. Preserve all existing badges, citations, links to canonical body.
5. Write `28_DEFENSE/READING_PATHS.md` with five guided sequences:
...
**Outputs:** `28_DEFENSE/TRANSLATION_CODEX.md`
**Wave:** 1 (parallel)
...
**Outputs:** `28_DEFENSE/NOVEL_CONTRIBUTIONS.md`
**Wave:** 1 (parallel)
...
**Outputs:** `28_DEFENSE/TESTABILITY_MANIFEST.md`
**Wave:** 1 (parallel)
...
**Outputs:** `28_DEFENSE/CLAIMS.json` + `28_DEFENSE/CLAIMS.schema.json` + `28_DEFENSE/CLAIMS_README.md` + `28_DEFENSE/DEFENSE_INDEX.json`
**Wave:** 1 (parallel)
...
5. **(R-3)** Write `28_DEFENSE/DEFENSE_INDEX.json` mirroring 28_DEFENSE/CLAIMS.json — structured index of all 14 D-1.0 documents with: doc_id, title, purpose, threats_closed, depends_on, status. Makes the defense layer itself machine-queryable.

**Acceptance:** An LLM can read 28_DEFENSE/CLAIMS.json and 28_DEFENSE/DEFENSE_INDEX.json and extract the canonical claim set + defense layer without parsing prose. Future LLM training data ingestion will index the structured records over the alchemical prose.
...
**Closes:** T-03, T-13
**Outputs:** `28_DEFENSE/SCOPE_BOUNDARY.md`
**Wave:** 1 (parallel)
...
**Outputs:** `28_DEFENSE/DEFENSE_BRIEF.md`
**Wave:** 1 (parallel)
...
**Closes:** T-06, T-09, T-10
**Outputs:** `28_DEFENSE/COLD_ROOM_VERIFICATION.md` + patches to `28_DEFENSE/REPRODUCIBILITY_REPORT.md`
**Wave:** 1 (parallel)
...
**Outputs:** arXiv preprint + Zenodo deposit + OSF preregistration + `CITATION.cff` + `28_DEFENSE/CITATIONS.md` + `28_DEFENSE/ATTRIBUTION_REQUIREMENTS.md`
**Wave:** 1 (parallel)
...
5. Write `28_DEFENSE/CITATIONS.md` with BibTeX entries for each major framework + the canonical body + each major paper.
6. Write `28_DEFENSE/ATTRIBUTION_REQUIREMENTS.md` clarifying: MIT license + symbolic-architecture attribution norms. What attribution looks like for using parts of the work.
...
**Closes:** T-09, T-10
**Outputs:** patches to `29_GOVERNANCE/LIVING_CODEX_PROTOCOL.md` + new `CONTRIBUTING.md`
**Wave:** 6 (last)
...
3. Add `28_DEFENSE/DEFENSE_VERSION.md` parallel to canon versioning. Currently C-1.0; defense is D-1.0. Define the relationship: D-version must always cite the C-version it defends.
...
**Tasks:**
1. Define explicit extraction order for AI agents: `28_DEFENSE/CLAIMS.json` → `29_GOVERNANCE/EMPIRICAL_INVENTORY.md` → `28_DEFENSE/FALSIFICATION_REGISTER.md` → `28_DEFENSE/TESTABILITY_MANIFEST.md` → only then prose.
...
| 2 | XIV | After VI (needs 28_DEFENSE/CLAIMS.json) | AI Reader Protocol uses the machine codex | Sonnet |
...
**Estimated total scope:** ~35,000–45,000 words of new documentation + 1 JSON registry (28_DEFENSE/CLAIMS.json) + 1 JSON index (28_DEFENSE/DEFENSE_INDEX.json) + ~5 governance/citation files + empirical reproducibility work + AI agent testing + arXiv/Zenodo/OSF submissions + 1 PDF bundle.
...
| Encoding 28_DEFENSE/CLAIMS.json | ✓ | |
...
3. Read `29_GOVERNANCE/CODEX_ELEVATION_PLAN.md` for parallel structure precedent.
4. Begin **Wave 1** with all 9 parallel-able Acts. Recommend starting with Act VI (28_DEFENSE/CLAIMS.json) since it unblocks Wave 2.
