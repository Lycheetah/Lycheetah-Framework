...
|--------|-------|--------|--------|
| CASCADE coherence improvement (synthetic) | **+40.3%** (0.58 → 0.93) | 3-condition experiment, 10 replications, classical→quantum physics domain | [ACTIVE] p < 0.001, d = 2.84 |
| CASCADE coherence improvement (real data) | **+110.05%** (0.47 → 1.0) | 5 historical paradigm shifts (germ theory, quantum mechanics, plate tectonics, heliocentrism, AI alignment), 200 trials each | [ACTIVE] framework engine, external data |
| CASCADE accuracy improvement | **+23.3%** (0.74 → 0.91) | Same synthetic experiment | [ACTIVE] p < 0.001, d = 1.92 |
| CASCADE catastrophic forgetting reduction | **-95.2%** (0.42 → 0.02 information loss) | Same synthetic experiment | [ACTIVE] large effect size |
...
| **You are Māori, iwi, hapū, or indigenous** | [`14_MYSTERY_SCHOOL/THE_INDIGENOUS_DOOR.md`](14_MYSTERY_SCHOOL/THE_INDIGENOUS_DOOR.md) — he taonga tuku iho — an offer, not an explanation |
...
10 core implementations with 219 automated tests
