...
| III — AURA I₂ ↔ Evidence Ladder | Schema-check (compute the four-element criterion across CLAIMS.json) | Implementable now; CI step proposed |
