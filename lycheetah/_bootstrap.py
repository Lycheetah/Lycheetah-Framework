...
#: Candidate roots in priority order. In a source checkout, prefer the canonical
#: legacy tree over the package bridge directories. In an installed wheel, setuptools
#: maps those same canonical trees beneath ``_HERE``.
