...
**Plan:** `C1_REFORGE_RECON.md`
**Maintained by:** Sol + Mac

**Purpose.** This register documents every prose change, status correction, new document, and structural extension made in the C-1.1 Reforge pass. It mirrors the format of `DOWNGRADE_REGISTER.md` (D-1.1 record) so a reviewer can audit any change without negotiation.
...
| R6 | L393 (claims paragraph) | "60 load-bearing claims" with single register | Disambiguation note added: CLAIMS.json (60 records, framework-detail) vs CLAIM_STATUS_LEDGER (59, framework-summary) | Closes C1 audit CC-01 |
| R7 | L406 (shape block) | "60 load-bearing claims tracked in CLAIMS.json" | Two lines: 60 status-tagged records (CLAIMS.json) + 59 load-bearing claims (LEDGER) | Same as R6 |
...
| F4 | L36–44 (status section) | "37 claims carry this status" with implicit single register | "37 records carry this status" + register disambiguation note pointing to CLAIMS_README.md | Closes CC-01 in this surface |
...
- `03_LAMAGUE/TRI_LINGUISTIC_DEEP_DIVE.md` — high "consciousness" density verified against scoping; uses tied to specific claims (CONJECTURE for Te Reo metaphysics). No edits.
- `02_AURA/THE_FOUR_PRINCIPLES.md` — three "paradigm" hits all technical. No edits.
...
New file: `SYNTHESES.md` — three structural syntheses stated explicitly for the first time:
...
### Extension: `CLAIM_STATUS_LEDGER.md` — downgrade and promotion triggers
...
| Issue | Resolution |
|---|---|
| Defense version drift (README badge vs DEFENSE_VERSION.md vs memory) | Reconciled: D-1.2 across all surfaces |
| Claim count divergence (60 vs 59) | Reconciled: README, FIVE_MINUTE_BRIEF, CLAIM_STATUS_LEDGER, and shape block all carry the disambiguation; CLAIMS_README.md cited as canonical mapping |
| C-1.1 reforge state | Recorded in DEFENSE_VERSION.md, CLAIM_STATUS_LEDGER.md header, FIVE_MINUTE_BRIEF.md header, README shape block |

---

## Statistics

- **Files modified:** 6 (README.md, FIVE_MINUTE_BRIEF.md, NOVEL_CONTRIBUTIONS.md, DEFENSE_VERSION.md, CASCADE_COMPLETE.md, CLAIM_STATUS_LEDGER.md)
- **Files created:** 4 (LICENSE, C1_REFORGE_RECON.md, SCOPE_DECLARATION.md, SYNTHESES.md, REFORGE_REGISTER.md)
