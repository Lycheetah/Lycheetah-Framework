...
export const TRUTH_PRESSURE_SHADOW_STORAGE_KEY = 'truth-pressure-shadow-v0.7';
export const TRUTH_PRESSURE_SHADOW_DATASET_VERSION = 'TP-SHADOW-DATASET-0.7' as const;
