...
**Depends on:** FORMAL_SPINE.md (Act II), EMPIRICAL_INVENTORY.md (Act VI)
...
**Location:** `CODEX_AURA_PRIME/12_IMPLEMENTATIONS/01_CASCADE/cascade_real_data.py`
...
**Location:** `CODEX_AURA_PRIME/12_IMPLEMENTATIONS/01_CASCADE/cascade_validator.py`
...
**Location:** `CODEX_AURA_PRIME/12_IMPLEMENTATIONS/02_AURA/aura_compliance_checker.py`
...
**Location:** `CODEX_AURA_PRIME/12_IMPLEMENTATIONS/03_LAMAGUE/lamague_tier1_encoder.py`
...
**Location:** `CODEX_AURA_PRIME/12_IMPLEMENTATIONS/04_TRIAD/triad_cycle_simulator.py`
...
**Location:** `CODEX_AURA_PRIME/12_IMPLEMENTATIONS/05_MICROORCIM/microorcim_drift_monitor.py`
...
**Location:** `CODEX_AURA_PRIME/12_IMPLEMENTATIONS/06_EARNED_LIGHT/earned_light_asymmetry.py`
...
[WARNING] Formula requires revision — see ADVERSARIAL_AUDIT_REPORT.md Section 1
...
falsified by the anesthesia paradox (see ADVERSARIAL_AUDIT_REPORT.md). The revised
...
**Location:** `CODEX_AURA_PRIME/12_IMPLEMENTATIONS/07_ANAMNESIS/anamnesis_tc_catalog.py`
...
1. Find C in PROVENANCE_INDEX.md — this gives the source file and estimated PDF page
2. Find C in EMPIRICAL_INVENTORY.md — this gives the support type and next experiment
3. Find the corresponding implementation in this report — run it to reproduce the result
4. Check ADVERSARIAL_AUDIT_REPORT.md — find the challenge to C and the verdict
