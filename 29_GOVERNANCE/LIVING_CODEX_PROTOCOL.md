...
- IRRESOLVABLE: genuinely open problem; moved to 29_GOVERNANCE/OPEN_PROBLEMS.md
...
30_MAPS/PROVENANCE_INDEX.md [updated entry]."
...
terminology. Action: update 30_MAPS/ONTOLOGY.md renaming register; add redirect in all
...
- If neither: downgrade from SCAFFOLD to ASPIRATIONAL (if currently SCAFFOLD),
  or move to 29_GOVERNANCE/OPEN_PROBLEMS.md as a long-term open question.
...
violate 29_GOVERNANCE/GOVERNANCE_AND_ETHICS.md.
...
|---|---|
| Claim status changes (SCAFFOLD → ACTIVE, ACTIVE → RETRACTED) | `28_DEFENSE/CLAIMS.json` (update record), `FIVE_MINUTE_BRIEF.md` (update counts), `28_DEFENSE/NOVEL_CONTRIBUTIONS.md` (update table), `28_DEFENSE/TESTABILITY_MANIFEST.md` (update protocol) |
| New framework added | `28_DEFENSE/CLAIMS.json` (new records), `28_DEFENSE/NOVEL_CONTRIBUTIONS.md` (new rows), `28_DEFENSE/TRANSLATION_CODEX.md` (new terms), `28_DEFENSE/TESTABILITY_MANIFEST.md` (new protocols), `README.md` (update framework list) |
| Claim retracted | `28_DEFENSE/CLAIMS.json` (update to RETRACTED), `28_DEFENSE/FAILURE_MUSEUM.md` (new exhibit), `FIVE_MINUTE_BRIEF.md` (update counts), `28_DEFENSE/SCOPE_BOUNDARY.md` (possibly update) |
| Theorem proved (SCAFFOLD → ACTIVE) | `28_DEFENSE/CLAIMS.json` (status update), `29_GOVERNANCE/EMPIRICAL_INVENTORY.md`, `28_DEFENSE/TESTABILITY_MANIFEST.md` (update replication notes) |
| New empirical result | `29_GOVERNANCE/EMPIRICAL_INVENTORY.md`, `28_DEFENSE/TESTABILITY_MANIFEST.md`, `FIVE_MINUTE_BRIEF.md`, `28_DEFENSE/NOVEL_CONTRIBUTIONS.md` |
...
`28_DEFENSE/DEFENSE_VERSION.md` (at repo root) tracks the current defense version and its relationship to the canonical version:
...
Status:    Active
Documents: 18 (per 28_DEFENSE/DEFENSE_INDEX.json)
```
