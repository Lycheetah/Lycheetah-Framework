...
def _route(*args, **kwargs):
    """Keep this module importable when the optional Flask extra is absent."""
    if app is None:
...
def main() -> int:
    """Start the demo, or report the missing optional web dependency."""
